function setupGame() {
    ...
    // Knight: works AFTER farmer agrees
    ...
    // Queen: works AFTER knight agrees
    let queenAskCount = 0;
    ...
    // Beach Town doors (correct order: Forest first, then Castle, then House)
    ...
    // Forest doors (correct order: Castle back door first, then Beach town)
